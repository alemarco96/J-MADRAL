...
def parse_args() -> argparse.Namespace:
    ...
    args.base_model_name = f"{os.environ['ESCISOTA_DATA']}{os.sep}models{os.sep}bi_encoders{os.sep}init{os.sep}rec-bibert-tdb_bert_init"
    # args.base_model_name = f"{os.environ['ESCISOTA_DATA']}{os.sep}models{os.sep}bi_encoders{os.sep}init{os.sep}rec-mtbert-tdb_bert_init"
    # args.base_model_name = f"{os.environ['ESCISOTA_DATA']}{os.sep}models{os.sep}bi_encoders{os.sep}init{os.sep}rec-madral-tdb_bert_init"
    ...
    args.r_corpus_filename = f"{os.environ['ESCISOTA_DATA']}{os.sep}datasets{os.sep}AmazonESCI_Reviews{os.sep}final{os.sep}corpus{os.sep}r{os.sep}rec_r_corpus.jsonl"
    args.r_queries_filename = f"{os.environ['ESCISOTA_DATA']}{os.sep}datasets{os.sep}AmazonESCI_Reviews{os.sep}final{os.sep}queries{os.sep}r{os.sep}rec_r_train_queries.jsonl"

    args.final_model_name = "rec-bibert-tdb_bert_pretrained"
    # args.final_model_name = "rec-mtbert-tdb_bert_pretrained"
    # args.final_model_name = "rec-madral-tdb_bert_pretrained"
...
def main():
    ...
    train_dataset = modeling.MultiPretrainDataset(
        corpora_data=[r_corpus_data, r_queries_data],
        corpora_samples_per_epoch=[len(r_corpus_data), len(r_queries_data)]
    )

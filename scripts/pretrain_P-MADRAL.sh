...
# --------------------------------------------------------------------------------
INIT_MODEL_OUTPUT_FOLDER="/path/to/root_folder/models/init_P-MADRAL"
PRETRAIN_MODEL_OUTPUT_FOLDER="/path/to/root_folder/models/pretrain_P-MADRAL"
...
R_CORPUS_FILENAME="/path/to/empty.jsonl"
R_QUERIES_FILENAME="/path/to/empty.jsonl"

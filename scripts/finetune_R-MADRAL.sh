...
# --------------------------------------------------------------------------------
PRETRAINED_MODEL_OUTPUT_FOLDER="/path/to/root_folder/models/pretrain_R-MADRAL"
FINETUNED_MODEL_OUTPUT_FOLDER="/path/to/root_folder/models/finetune_R-MADRAL"
...
P_CORPUS_FILENAME="../data/empty.jsonl"
P_QUERIES_FILENAME="../data/empty.jsonl"
P_TRAIN_FILENAME="../data/empty.jsonl"
...
if [[ ! -fd "${FINETUNED_MODEL_OUTPUT_FOLDER}" ]]; then
